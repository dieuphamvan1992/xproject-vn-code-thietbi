...
class Quanlyhoadonnhap extends Tb_controller {
    ...
    public function index() {
        ...
        $temp['data']['list_hoadonxuat'] = $this->Mhoadon->getAllHoaDonNhap();

        $temp['title'] = "Quản lý hoá đơn nhập";
        $temp['template'] = 'hoadon/nhap';
