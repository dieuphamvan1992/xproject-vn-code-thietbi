...
class Msearch extends CI_Model{
    ...
    public function searchItem($data){
        ...
        if (isset($data['id_don_vi_quan_ly']) && ($data['id_don_vi_quan_ly']) !==''){
            $this->db->where('left(ma_dv, (length("'.$data['id_don_vi_quan_ly'].'"))) = ' ,$data['id_don_vi_quan_ly']);
        }
        ...
        */
        ...
        $this->db->join('hutstaff.dm_dv as e', 'e.ma_dv = thiet_bi_su_dung.id_don_vi_quan_ly COLLATE utf8_general_ci', 'LEFT');
        ...
        e.dv as don_vi, dm_khu_nha.ten as khu_nha, dm_ten_thiet_bi.ten, thiet_bi_su_dung.id');
    ...
    public function searchBatch($data){
        ...
        */
        ...
        $this->db->select('COUNT(thiet_bi_su_dung.id),dm_ten_thiet_bi.ten as ten, dm_ten_thiet_bi.id,
            e.dv as don_vi, dm_loai_thiet_bi.ten as loai, id_chi_tiet_xuat, xuat.so_hoa_don,
