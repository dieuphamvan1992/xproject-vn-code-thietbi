...
<script type="text/javascript">
  function validateForm()
  {
    ...
    if (cells.length ==0)
  { alert('Chưa có thiết bị nào trong hoá đơn!');
    return false;}
   return true;
  }
</script>
      ...
      <div class="box-show-content">
          <div class="table-box">
              <table class="table table-bordered" id="tablex">
                  ...
                  <?php
                   $attributes = array('name' => 'myform', 'id' => 'myform', 'onsubmit'=>'return validateForm();');
                  ...
                  echo form_open('hoadon/nhap/doCreate',$attributes);
                  if (!empty($nhaps)) {
              //    var_dump($xuat);
          ...
          <div class="container-box">
              ...
              <div class="three-column">
                  <div class="box">
                      ...
                      <div class="input-box">
                          <input type="text" name="don_gia" id = "dongia" autocomplete="off" />
                      </div>
