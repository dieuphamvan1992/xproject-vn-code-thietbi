...
<div class="container-box">
    ...
    <div class="three-column">
        ...
        <div class="box">
            ...
            <div class="input-box">
                <input type="text" name="ngayThucHien" value="<?php echo set_value('ngayThucHien',$thongTinChung['ngayThucHien']); ?>" />
            </div>
    ...
    <div class="three-column">
        <div class="box">
            ...
            <div class="input-box">
                <input type="text" name="nguonVon" value="<?php echo set_value('nguonVon',$thongTinChung['nguonVon']); ?>"/>
            </div>
